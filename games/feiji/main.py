...
import sys
import traceback
import games.feiji.myplane as myplane
import games.feiji.enemy as enemy
import games.feiji.bullet as bullet
import games.feiji.supply as supply
import games.feiji.supply as Bomber

from games.feiji.setting import *
from pygame.locals import *
from random import *

import games.feiji.background_1 as background_1
pygame.init()
pygame.mixer.init()
...
# ****************************************************************
        ...
        # 绘制游戏结束画面
            ...
            if not recorded:
                recorded = True
                # 读取历史最高得分
                with open("games/feiji/record.txt", "r") as f:
                    global record_score
